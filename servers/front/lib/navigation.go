...
const (
	...
	AwsCostsTotal                endpoints.ApiEndpoint = "/{version}/aws/costs/total/{billing_date:-5}/{billing_date:1}"                  // Returns the overal total between the dates (ex. Tax)
...
func teamItems() (navs []*navigation.Navigation) {
	...
	for _, team := range teams {
		...
		monthlyCosts := navigation.New(
			...
			&navigation.Display{PageTemplate: "team-historical-costs"},
			&navigation.Data{
