...
func Import(ctx context.Context, log *slog.Logger, db *sqlx.DB, data []*codebasemodels.Codebase) (statements []*dbstatements.DataStatement[*codebasemodels.Codebase, int], err error) {

	statements = []*dbstatements.DataStatement[*codebasemodels.Codebase, int]{}
	...
	for _, row := range data {
		statements = append(statements, &dbstatements.DataStatement[*codebasemodels.Codebase, int]{
