...
func TestDomainSelectsInfracostsAll(t *testing.T) {
	...
	var (
		...
		dbPath string          = filepath.Join(dir, "test-domain-selects-infracosts.db")
	)
	// set the database
	...
	seeded, err := infracostseeds.Seed(ctx, log, db)
	if err != nil {
