// package uptimegetter handles fetching and returning uptime data via route53 healthchecks.
//
// Fecthes list of metrics from the "AWS/Route53" namespace and then data for those
// metrics to decide uptime values
//
// Uses monthly grouping, so granualrity is typically 1 hour
package uptimegetter
