...
const ENDPOINT_BASE string = `/v1/costs/detailed/between/{date_start}/{date_end}/`
const ENDPOINT_TEAM string = `/v1/costs/detailed/between/{date_start}/{date_end}/team/{team}/`
