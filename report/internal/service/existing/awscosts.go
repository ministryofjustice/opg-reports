...
//
// We use the old account_id field for the join information
func (self *Service) InsertAwsCosts(client awsr.ClientS3ListAndGetter, source awsr.RepositoryS3BucketDownloader, sq sqlr.RepositoryWriter) (results []*sqlr.BoundStatement, err error) {
	var dir string
