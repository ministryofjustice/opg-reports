...
import (
	...
	"opg-reports/report/internal/global/importinterfaces"
...
type Clients struct {
	Teams importinterfaces.TeamClient // *github.TeamsService
	Repos importinterfaces.RepoClient // *github.RepositoriesService
}
...
func handleCodebaseOwners(ctx context.Context, client clients.RepoClient, repositories []*github.Repository, in *Args) (err error) {
...
func toCodebaseOwners(ctx context.Context, client clients.RepoClient, list []*github.Repository, in *Args) (data []*CodebaseOwner, err error) {
...
// of github results
func getTeams(ctx context.Context, client clients.RepoClient, code *github.Repository, in *Args) (teams []*github.Team, err error) {
	var (
...
func getCodeownersFromFiles(ctx context.Context, client clients.RepoClient, code *github.Repository, in *Args) (owners []string, err error) {
	var (
...
// into one block
func getRepositoryList(ctx context.Context, client clients.TeamClient, options *Args) (repositories []*github.Repository, err error) {
