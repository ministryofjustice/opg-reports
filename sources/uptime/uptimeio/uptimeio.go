...
// Body is the normal body for a resposne
type Body struct {
	Type         string                            `json:"type" doc:"States what type of data this is for front end handling"`
	Request      *Input                            `json:"request" doc:"The public parameters originaly specified in the request to this API."`
...
// Output is the standard response
type Output struct {
	Body *Body
}
